...
class TestBooksCollector:
    ...
    def test_add_new_book_len_name_39_and_40_symbols(self, collector, len_name):

        collector.add_new_book(len_name)
        assert len_name in collector.get_books_genre()

    def test_add_new_book_len_name_41_symbols_negative(self, collector):
    ...
    def test_get_books_genre_with_two_books(self, collector):
